...
const EmployeeDashboard = () => { 
  return (
    <main className="bg-[#161a22] w-full min-h-screen ml-54 p-5 flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-10 rounded-2xl border border-[#262b3a] p-5 min-h-125">
         <h1 className="text-xl font-semibold text-gray-200">Today's Schedule</h1>
      </div>
      <div className="flex flex-col gap-10 rounded-2xl border border-[#262b3a] p-5 min-h-50">
         <h1 className="text-xl font-semibold text-gray-200">Your Working Hours Today</h1>
         <div className="flex gap-5 items-center">
          <div className=" bg-[#1c2230] h-20 w-50 flex items-center gap-4 px-7 rounded-2xl ">
            ...
            <h2>
              ...
              <p className="text-white text-xl font-bold">9:00</p>
            </h2>
          </div>
