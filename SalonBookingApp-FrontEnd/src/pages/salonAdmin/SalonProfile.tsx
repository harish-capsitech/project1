...
const SalonProfile = () => {
  ...
  return (
    <ConfigProvider theme={{algorithm: theme.darkAlgorithm}}>
      ...
      <main className="bg-[#161a22] w-full min-h-screen ml-54 p-5 flex flex-col gap-3">
        <div className="">
          <h1 className="text-gray-200 text-2xl font-bold">Company Profile</h1>
        ...
        <div className="bg-[#242a35] border border-[#262b3a] rounded-2xl p-4">
          <h1 className="text-gray-200 text-xl font-bold mb-2">Business Hours</h1>
          <div className="space-y-1">
            ...
            {/* <button className="bg-[#6c5ce7] text-white flex items-en justify-end text-sm px-4 py-2 rounded-2xl">
              Save
            </button> */}
          </div>
