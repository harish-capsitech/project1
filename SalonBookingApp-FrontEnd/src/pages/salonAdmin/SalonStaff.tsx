...
import { Space, Typography, Tag, Divider, Switch, Button, Row, Col } from "antd";
import {
  UserOutlined,
  MailOutlined,
  PhoneOutlined,
      ...
      <div className="flex flex-col gap-2">
        ...
        {staff.map((data, index) => (
          <Col key={index} xs={24} sm={24} md={12} lg={10} xl={8} >
            ...
            <div className="p-5 rounded-2xl bg-[#0f172a] border border-[#262b3a] shadow-2xl mb-5" key={index}>
              <Space
                align="start"
