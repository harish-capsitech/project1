...
const Dashboard: React.FC = () => {
  const goToLogin = () => {
    // apne route ke hisaab se change kar lena
        ...
        <main className="flex-1">
          ...
          <div className="px-6 py-6 space-y-6">
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div>
                  ...
                  <p className="mt-3 text-white/60 max-w-2xl">
                    One booking = multiple services + single continuous time block.
                    Conflict-safe scheduling with UTC time storage.
                  </p>
                ...
                <div className="w-full lg:w-90 rounded-3xl border border-white/10 bg-[#0B0F19]/60 p-5">
                  <div className="flex items-center justify-between">
                    <div className="text-sm font-semibold">System Highlights</div>
                    <div className="text-xs text-white/40">Live MVP</div>
                  </div>
            ...
            <footer className="pb-10 text-center text-xs text-white/35">
              © {new Date().getFullYear()} SalonHub MVP • Built with React + TS +
              Tailwind + Antd
            </footer>
          </div>
        </main>
