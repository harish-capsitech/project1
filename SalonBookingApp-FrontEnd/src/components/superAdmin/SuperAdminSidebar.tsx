...
const SuperAdminSidebar = () => {
  ...
  return (
    <div className="fixed md:px-2.5 py-5 flex flex-col justify-between h-screen w-15 md:w-55 border-r border-r-[#262b3a]" >
      <div className="">
      ...
      <div className="flex flex-col gap-2">
        <NavLink to="/superadmin/profile" className="bg-[#333241] rounded-lg p-3 flex items-center gap-3">
