  ...
  return (
    <div className="fixed px-2.5 py-5 flex flex-col justify-between h-screen w-55 border-r border-r-[#262b3a]" >
        ...
        <Menu
          ...
          items={[
            ...
            },
            {
              ...
              label: <NavLink to="/salonadmin/company-profile">Company Profile</NavLink>,
            },
            {
      ...
      <div className="flex flex-col gap-2">
        <NavLink to="/salonadmin/profile" className="bg-[#333241] rounded-lg p-3 flex items-center gap-3">
