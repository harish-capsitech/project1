...
import SalonAdminRegister from "./components/salonAdmin/SalonAdminRegister";
...
const cusDashboard = (<><CustomerNavbar/><CustomerDashboard/></>)
const cusBookings = (<><CustomerNavbar/><CustomerBookings/></>)
const cusBook = (<><CustomerNavbar/><Book/></>)
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/register-salon" element={<SalonAdminRegister/>} />
    </Routes>
  )
}
